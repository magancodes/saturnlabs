    ...
    <div className="bg-[#050505]">
      ...
      >
        ...
        <nav className="flex flex-col items-center gap-12">
          <a
            href="#"
            onClick={() => setMenuOpen(false)}
            className="font-gilroy text-white/80 hover:text-white transition-opacity"
            style={{ fontSize: "28px" }}
          >
            home
          </a>
      ...
      >
        <div>
          ...
          <div className="blur-in" style={{ animationDelay: "0.6s" }}>
            <a
              href="#"
              className="bg-white/5 backdrop-blur-xl border border-white/20 shadow-[0_8px_32px_rgba(0,0,0,0.3)] font-gilroy font-medium text-white inline-flex items-center hover:bg-white/10 hover:border-white/30 hover:shadow-[0_8px_32px_rgba(255,255,255,0.05)] transition-all duration-300 group"
              style={{ padding: "18px 40px", borderRadius: "12px", fontSize: "15px", gap: "20px" }}
            >
              check samples
      ...
      <section id="narrative-section" className="relative z-10 w-full min-h-screen bg-black overflow-hidden flex items-center justify-center">
        <div className="relative w-full max-w-5xl mx-auto px-24 md:px-12 text-center h-[300px]">
          <div className="narrative-text absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full font-gilroy font-normal text-white text-[17px] md:text-[23px] tracking-[0.05em] leading-relaxed">
            <EncryptedText 
        ...
        <div className="absolute bottom-0 left-0 w-full h-[650px] md:h-[500px] overflow-hidden pointer-events-none">
