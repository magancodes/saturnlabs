    ...
    <div className="bg-[#050505] min-h-screen">
      ...
      >
        <Link href="/" className="flex items-center gap-4 shrink-0">
          ...
          />
          <span
            className="font-gilroy font-normal tracking-tight text-white"
            style={{ fontSize: "22px" }}
          >
            Saturn Labs
          </span>
        ...
        <nav className="hidden lg:flex items-center absolute left-1/2 -translate-x-1/2 gap-[64px]">
          <Link
            href="/"
            className="font-gilroy text-white/50 hover:text-white transition-colors"
            style={{ fontSize: "15px" }}
          >
            home
          </Link>
          ...
          <Link
            href="/research"
            className="font-gilroy text-white transition-colors"
            style={{ fontSize: "15px" }}
          >
            research
          </Link>
        ...
        <a
          href="#collaborate"
          className="hidden lg:inline-flex bg-white text-black font-gilroy font-semibold items-center hover:opacity-90 transition-all"
          style={{
            padding: "14px 28px",
            borderRadius: "8px",
            fontSize: "14px",
